 ...
 *
 * Currently there are only two, the production chain and the test chain. But in future as Feathercoin
...
public class NetworkParameters implements Serializable {
    ...
    public static final String ID_TESTNET = "org.feathercoin.test";
    /** Unit test network. */
    static final String ID_UNITTESTNET = "com.google.feathercoin.unittest";
     ...
     *
     * <p>The first block in every chain is a well known constant shared between all Feathercoin implemenetations. For a
     ...
     * test and production Feathercoin networks use 2 weeks (1209600 seconds).
     */
    ...
    private NetworkParameters(int type) {
        ...
        if (type == 0 || type == 100) {
            ...
            genesisBlock.setMerkleRoot(new Sha256Hash("97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9")); // FC
            id = ID_PRODNET;
            subsidyDecreaseBlockCount = 3360000; // FC
     ...
     */
    public static final BigInteger MAX_MONEY = new BigInteger("336000000", 10).multiply(COIN); // FC
    ...
    /** The primary Feathercoin chain created by Satoshi. */
    ...
    /** The primary Feathercoin chain created by Hank. */
