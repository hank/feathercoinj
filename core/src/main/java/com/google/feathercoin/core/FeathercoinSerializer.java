 ...
 * <a href="https://en.feathercoin.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.feathercoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class FeathercoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(FeathercoinSerializer.class);
    ...
    /**
     * Constructs a FeathercoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public FeathercoinSerializer(NetworkParameters params) {
     ...
     */
    public FeathercoinSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("FeathercoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
        ...
        byte[] payload = message.feathercoinSerialize();
    ...
    public Message deserialize(InputStream in) throws ProtocolException, IOException {
        // A Feathercoin protocol message has the following format.
        //
        ...
        FeathercoinPacketHeader header = new FeathercoinPacketHeader(in);
     ...
     */
    public FeathercoinPacketHeader deserializeHeader(InputStream in) throws ProtocolException, IOException {
        return new FeathercoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link FeathercoinSerializer#deserializeHeader}.
     */
    public Message deserializePayload(FeathercoinPacketHeader header, InputStream in) throws ProtocolException, IOException {
        int readCursor = 0;
    ...
    public static class FeathercoinPacketHeader {
        public final byte[] header;
        public final String command;
        public final int size;
        public final byte[] checksum;

        public FeathercoinPacketHeader(InputStream in) throws ProtocolException, IOException {
