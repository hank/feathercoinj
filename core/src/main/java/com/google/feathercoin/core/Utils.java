...
public class Utils {
     ...
     * <p/>
     * A nanocoin is the smallest unit that can be transferred using Feathercoin.
     ...
     * standard procedure in Feathercoin. The resulting hash is in big endian form.
     */
     ...
     */
    public static String feathercoinValueToFriendlyString(BigInteger value) {
     ...
     */
    public static String feathercoinValueToPlainString(BigInteger value) {
        if (value == null) {
     ...
     *
     * <tt><p>[24] "Feathercoin Signed Message:\n" [message.length as a varint] message</p></tt>
     */
