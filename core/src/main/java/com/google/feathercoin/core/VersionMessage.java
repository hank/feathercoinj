...
public class VersionMessage extends Message {
    ...
    @Override
    public void feathercoinSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.feathercoinSerialize(buf);
            // Their address.
            theirAddr.feathercoinSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     * set of "/FeathercoinJ:1.0/MultiBit:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
     * components. If you don't want to add a comment (recommended), pass null.<p>
     *
     * See <a href="https://en.feathercoin.it/wiki/BIP_0014">BIP 14</a> for more information.
     *
