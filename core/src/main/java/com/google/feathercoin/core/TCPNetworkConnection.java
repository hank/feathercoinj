...
/**
 * <p>A {@code TCPNetworkConnection} is used for connecting to a Feathercoin node over the standard TCP/IP protocol.<p>
 *
...
public class TCPNetworkConnection implements NetworkConnection {
    ...
    private FeathercoinSerializer serializer = null;
    ...
    public TCPNetworkConnection(NetworkParameters params, VersionMessage ver) {
        ...
        this.serializer = new FeathercoinSerializer(this.params);
    ...
    private void onVersionMessage(Message m) throws IOException, ProtocolException {
        ...
        // feathercoinj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    public class NetworkHandler extends ReplayingDecoder<VoidEnum> implements ChannelDownstreamHandler {
        ...
        // Attempt to decode a Feathercoin message passing upstream in the channel.
        //
        ...
        /** Serialize outgoing Feathercoin messages passing downstream in the channel. */
    ...
    /** Returns the Netty Pipeline stage handling Feathercoin serialization for this connection. */
