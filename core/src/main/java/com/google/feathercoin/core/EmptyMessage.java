 ...
 * Currently this includes getaddr, ping, verack as well as the special feathercoinj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void feathercoinSerializeToStream(OutputStream stream) throws IOException {
    }
    ...
    /* (non-Javadoc)
      * @see Message#feathercoinSerialize()
      */
    @Override
