 ...
 * format is defined by the <tt>feathercoin.proto</tt> file in the feathercoinj source distribution.<p>
 *
...
public class WalletProtobufSerializer {
    ...
    protected WalletTransaction connectTransactionOutputs(org.feathercoinj.wallet.Protos.Transaction txProto) {
